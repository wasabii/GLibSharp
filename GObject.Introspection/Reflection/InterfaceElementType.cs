...
namespace GObject.Introspection.Reflection
{
    ...
    class InterfaceElementType : InterfaceType
    {
        ...
        public InterfaceElementType(IntrospectionContext context, Interface iface) :
            base(context)
        {
        ...
        {
            return iface.Callbacks.Select(i => new IntrospectionTypeMember(Context, this, new CallbackElementType(Context, i)));
        }
