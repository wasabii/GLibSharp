...
namespace GObject.Introspection.Model
{
    ...
    class PrimitiveNativeTypeSymbolSource : INativeTypeSymbolSource
    {
        ...
        readonly ConcurrentDictionary<NamespaceElement, Dictionary<string, PrimitiveNativeTypeSymbol>> cache;
        ...
        public PrimitiveNativeTypeSymbolSource(NamespaceLibrary namespaces)
        {
            ...
            cache = new ConcurrentDictionary<NamespaceElement, Dictionary<string, PrimitiveNativeTypeSymbol>>();
        }
        ...
        /// <returns></returns>
        Dictionary<string, PrimitiveNativeTypeSymbol> GetCTypeMap(NamespaceElement ns, string typeName)
        {
            if (ns is null)
                throw new ArgumentNullException(nameof(ns));
            if (typeName is null)
        ...
        /// <param name="ns"></param>
        /// <returns></returns>
        IEnumerable<Element> GetCTypes(NamespaceElement ns)
        {
            if (ns is null)
                throw new ArgumentNullException(nameof(ns));
