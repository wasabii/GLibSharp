...
namespace GObject.Introspection.CodeGen.Model
{
    ...
    class ManagedTypeSymbolSource : ITypeSymbolSource
    {
        ...
        readonly ConcurrentDictionary<NamespaceElement, Dictionary<string, ITypeSymbol>> cache;
        ...
        public ManagedTypeSymbolSource(NamespaceLibrary namespaces, IManagedTypeResolver resolver)
        {
            ...
            cache = new ConcurrentDictionary<NamespaceElement, Dictionary<string, ITypeSymbol>>();
        }
        ...
        /// <returns></returns>
        public ITypeSymbol ResolveSymbol(string ns, string version, string name)
        {
            if (ns is null)
        ...
        /// <returns></returns>
        Dictionary<string, ITypeSymbol> GetClrInfoTypeMap(NamespaceElement ns, string typeName)
        {
            if (ns is null)
                throw new ArgumentNullException(nameof(ns));
            if (typeName is null)
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        ITypeSymbol GetTypeSymbol(string name)
        {
            if (name is null)
                throw new ArgumentNullException(nameof(name));
