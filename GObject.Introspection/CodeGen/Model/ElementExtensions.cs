...
namespace GObject.Introspection.CodeGen.Model
{
    ...
    static class ElementExtensions
    {
        ...
        /// <returns></returns>
        public static ITypeSymbol ToSymbol(this TypeElement type, Context context)
        {
            if (context is null)
        ...
        /// <summary>
        /// Translates the given <see cref="AnyTypeElement"/> element into a <see cref="ITypeSymbol"/>.
        /// </summary>
        /// <param name="context"></param>
        /// <param name="type"></param>
        /// <returns></returns>
        public static TypeSpec ToSpec(this AnyTypeElement type, Context context)
        {
            ...
            return type switch
            {
                TypeElement t => GetTypeSpec(context, t),
        ...
        /// <summary>
        /// Translates the given <see cref="TypeElement"/> element into a <see cref="TypeSpec"/>.
        /// </summary>
        /// <param name="context"></param>
        /// <param name="type"></param>
        /// <returns></returns>
        static TypeSpec GetTypeSpec(Context context, TypeElement type)
        {
            if (context is null)
                throw new ArgumentNullException(nameof(context));
