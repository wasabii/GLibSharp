...
namespace GObject.Introspection.CodeGen.Model
{
    ...
    class TypeSymbolProvider
    {
        ...
        readonly ConcurrentDictionary<(string, string, string), ITypeSymbol> cache;
        ...
        public TypeSymbolProvider(IEnumerable<ITypeSymbolSource> sources)
        {
            ...
            cache = new ConcurrentDictionary<(string, string, string), ITypeSymbol>();
        }
        ...
        /// <returns></returns>
        public ITypeSymbol Resolve(string ns, string version, string name)
        {
            if (ns is null)
        ...
        ITypeSymbol ResolveInternal(string ns, string version, string name)
        {
