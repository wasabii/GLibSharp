...
namespace GObject.Introspection.CodeGen.Model
{
    ...
    class Module
    {
        ...
        /// <summary>
        /// Adapts a list of type definitions to a list of types.
        /// </summary>
        ...
        /// <param name="ns"></param>
        /// <returns></returns>
        IEnumerable<(string ns, string version)> GetImports(NamespaceElement ns)
        {
        ...
        /// <summary>
        /// Gets the owning <see cref="ModuleLibrary"/>.
        /// </summary>
